...
I wrote this small OpenGL program to learn about shaders and rendering models. The default model is a chess pawn. To compile the code, make sure the GLEW, glm math, and Freeglut libraries are installed and make sure you can
